...
public abstract class RelOptUtil {
   ...
   *
   * Note: here we assume RelOptUtil.classifyFilters has been called first,
   * such that the left filters or right filters have been removed from join
   * conditions.
   */
  public static RelNode pushExpInEqualJoinCondIntoProj(RelOptCluster cluster,
                                             RexNode joinCond,
                                             JoinRelType joinType,
                                             RelNode leftRel,
                                             RelNode rightRel) {
